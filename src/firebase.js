...
export const MYDEVIL_URL = 'https://www.nalewki.ebra.pl/upload_image.php';
export const COL_RECIPES = 'nalewki_recipes';
export const COL_CATEGORIES = 'nalewki_categories';
